...
-- WHERE round([1002] * 0.05 + [1002], 2) != [1015]
-- WHERE round([1002] * 0.10 + [1002], 2) != [1028]
-- WHERE round([1002] * 0.12 + [1002], 2) != [1041]
-- WHERE round([1002] * 0.15 + [1002], 2) != [1079]
 WHERE round([1002] * 0.20 + [1002], 2) != [1056]
